          ...
          <div className="form-group">
            <Label className="control-label">Schedule</Label>
            {
              user.schedule ?
                ...
                : <p>
                  Current employee uses <strong><a data-vpp="link-to-company-schedule">company wide</a></strong> schedule.
                </p>
            }

            <div className="input-group">
              <div className="btn-group" data-toggle="buttons">
                <Label className={'btn btn-default ' + (schedule.monday === 1 ? 'active' : '')}>
                  {
                    schedule.monday === 1 ?
                  ...
                  Mon</Label>
                <Label className={'btn btn-default ' + (schedule.tuesday === 1 ? 'active' : '')}>
                  {
                    schedule.tuesday === 1 ?
                  ...
                  Tue</Label>
                <Label className={'btn btn-default ' + (schedule.wednesday === 1 ? 'active' : '')}>
                  {
                  ...
                  Wed</Label>
                <Label className={'btn btn-default ' + (schedule.thursday === 1 ? 'active' : '')}>
                  {
                    schedule.thursday === 1 ?
                  ...
                  Thu</Label>
                <Label className={'btn btn-default ' + (schedule.friday === 1 ? 'active' : '')}>
                  {
                    schedule.friday === 1 ?
                  ...
                  Fri</Label>
                <Label className={'btn btn-default ' + (schedule.saturday === 1 ? 'active' : '')}>
                  {
                    schedule.saturday === 1 ?
                  ...
                  Sat</Label>
                <Label className={'btn btn-default ' + (schedule.sunday === 1 ? 'active' : '')}>
                  {
                    schedule.sunday === 1 ?
